    ...
    render() {
        return (
            <>
              ...
              <footer id="contact" className="text-center text-lg-start bg-light text-muted ">
 
 <div className="me-5 mt-5 d-none d-lg-block">
   ...
   <div className="row mt-3">
     ...
     <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
       ...
       <h6 className="text-uppercase fw-bold mb-4">
         <i className="fas fa-gem me-3" />the gift shop
       </h6>
       <p>
     ...
     <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
       ...
       <p>
         <a href="#!" className="text-reset">Boxes</a>
       </p>
